...
function AnalyticsQuery(opts) {
  if (!(this instanceof AnalyticsQuery))
    return new AnalyticsQuery(opts);
  this.opts = opts || {};
  this.data = this.opts.data || {};
  this.namespace = "youtubeAnalytics";
 ...
 * @api private
 */
AnalyticsQuery.prototype.path = function(client) {
  debug(JSON.stringify(this.data));
  return client[this.namespace].reports.query(this.data);
};
...
AnalyticsQuery.prototype.startDate = function(d) {
  this.data["start-date"] = formatDate(d);
  return this;
}
...
AnalyticsQuery.prototype.endDate = function(d) {
  this.data["end-date"] = formatDate(d);
  return this;
}
 ...
 * @api public
 */
AnalyticsQuery.prototype.startAt = function(i) {
